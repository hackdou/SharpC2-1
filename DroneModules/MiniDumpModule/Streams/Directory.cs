...
namespace MiniDumpModule.Streams
{
    public class Directory
    {
        ...
        public static List<MINIDUMP_DIRECTORY> ParseDirectory(MiniDump minidump)
        {
            ...
            {
                minidump.BinaryReader.BaseStream.Seek(minidump.Header.StreamDirectoryRva + i * 12, 0);
                UInt32 raw_stream_type_value = Helpers.ReadUInt32(minidump.BinaryReader);
                ...
                md.Size = Helpers.ReadUInt32(minidump.BinaryReader);
                md.Offset = Helpers.ReadUInt32(minidump.BinaryReader);
                directories.Add(md);
            }
