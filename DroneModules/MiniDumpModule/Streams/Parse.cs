...
namespace MiniDumpModule.Streams
{
    ...
    {
        public static int parseMM(ref MiniDump minidump, List<Directory.MINIDUMP_DIRECTORY> directories)
        {
            foreach (Directory.MINIDUMP_DIRECTORY dir in directories)
            {
                ...
                else if (dir.StreamType == Directory.MINIDUMP_STREAM_TYPE.SystemInfoStream)
                {
                    ...
                    minidump.SystemInfo = SystemInfo.parse(dir, minidump);
                ...
                else if (dir.StreamType == Directory.MINIDUMP_STREAM_TYPE.Memory64ListStream)
                {
                    ...
                    minidump.MemorySegments64 = MINIDUMP_MEMORY64.parse(dir, minidump);
