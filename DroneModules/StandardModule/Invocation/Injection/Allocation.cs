...
namespace StandardApi.Invocation.Injection
{
    ...
    public class NtMapViewOfSection : AllocationTechnique
    {
        ...
        private const uint LocalSectionPermissions = Data.Win32.WinNT.PAGE_EXECUTE_READWRITE;
        private const uint RemoteSectionPermissions = Data.Win32.WinNT.PAGE_EXECUTE_READWRITE;
        private const uint SectionAttributes = Data.Win32.WinNT.SEC_COMMIT;
